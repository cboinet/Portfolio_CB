  ...
  return (
    <section className="portfolio_container">
      ...
      <div className="portfolio_projet">
        ...
        <Projet titre="Sellect" description="Site d'un client qui renégocie vos différents contrats pour un gain de pouvoir d'achat" illustration="" techno={ <Skill name="React.js, Node.js/Express, MySQL" image="fa-brands fa-react, fa-brands fa-node-js"/> } gh="" />
      </div>
    </section>
  );
};